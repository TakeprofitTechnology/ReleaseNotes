...
* Position lifetime value has been added to external data
...
* External order ID (FIX tag 11) is added to imported execution report (exported in WebGUI config).


## Version 26.01.30.29 (30 January, 2026)
### Changes
* The bug of incorrect behavior regarding SessionQualifiers in acceptors is fixed.
