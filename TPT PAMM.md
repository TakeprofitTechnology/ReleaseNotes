...
* Added My Accounts, allowing investors and leaders to view their PAMM accounts linked by the same MT5 address. Financial figures are shown only for the currently signed-in account.
