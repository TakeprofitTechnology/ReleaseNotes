...
* Crash attribution: when a third-party plugin or mtsrv internals crash the server, Windows Event Log now correctly identifies the actual faulting DLL instead of blaming Ashira.
